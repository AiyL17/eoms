...
<div class="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
    ...
    {{-- System Total EOs --}}
    <a href="{{ route('executive-orders.index') }}" class="stat-card hover:ring-2 hover:ring-emerald-200 hover:shadow-md transition-all">
        ...
        <div>
            ...
            <p class="text-[11px] text-slate-400 mt-0.5">{{ $activeEos }} active</p>
        </div>
    </a>

    {{-- This Year --}}
    <a href="{{ route('executive-orders.index', ['year' => date('Y')]) }}" class="stat-card hover:ring-2 hover:ring-amber-200 hover:shadow-md transition-all">
        ...
        <div>
            ...
            <p class="text-2xl font-bold text-slate-900 mt-0.5">{{ number_format($thisYearEos) }}</p>
            <p class="text-[11px] text-slate-400 mt-0.5">EOs issued in {{ date('Y') }}</p>
        </div>
    </a>

</div>

{{-- ── My Recent Uploads + EO Status Overview ──────────────────────────────── --}}
    ...
    <div class="lg:col-span-2 card">
        <div class="card-header">
            <div>
                ...
                <p class="text-xs text-slate-400 mt-0.5">Executive orders you have submitted</p>
            </div>
...
{{-- ── My Activity + Needs Attention + My Upload Sparkline ───────────────── --}}
<div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
    ...
    {{-- Right column: Needs Attention + My Upload Sparkline --}}
    <div class="space-y-6">
        ...
        <div class="card">
            ...
            <div class="p-4 space-y-2 overflow-y-auto" style="max-height: 220px;">
        ...
        <div class="card">
            ...
            <div class="px-6 pb-6 pt-2 border-t border-slate-100 mt-2">
                ...
                <div class="space-y-2">
                    <a href="{{ route('executive-orders.create') }}" class="flex items-center gap-2 px-3 py-2 rounded-xl hover:bg-violet-50 text-slate-700 hover:text-violet-700 transition-colors group">
                        ...
                        <span class="text-sm font-medium">Upload New EO</span>
                    </a>
